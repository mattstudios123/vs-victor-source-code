	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Victor Super Sides', 15);
					addMoreText('e portado por', 15);
					addMoreText('Mattzinho', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['em associacao', 'com'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 7:
					addMoreText('victor', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
